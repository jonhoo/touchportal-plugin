...
pub fn plugin() -> PluginDescription {
    // This plugin tests validation failure for actions with empty names
    PluginDescription::builder()
        .api(ApiVersion::V4_3)
        .version(1)
        .name("Missing Required Fields Test")
        .id("com.test.missing-required-fields")
        .configuration(
        ...
        .plugin_start_cmd(format!(
            "%TP_PLUGIN_FOLDER%MissingRequiredFields/{}{}",
                            ...
                            Lines::builder()
                                .action(
                                    LingualLine::builder()
                                        .datum(
                                            Line::builder()
                                                .line_format("Action with empty name")
                                                .build()
                                                .unwrap(),
                                        )
                                        .build()
